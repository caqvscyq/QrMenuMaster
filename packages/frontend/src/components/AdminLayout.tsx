    ...
    <div className="flex h-screen bg-neutral-50 dark:bg-neutral-900">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          {/* Mobile Sidebar */}
          <aside className="fixed left-0 top-0 h-full w-64 bg-secondary-gray dark:bg-neutral-800 transform transition-transform duration-300 ease-in-out">
            {/* Header with close button */}
            <div className="flex items-center justify-between h-16 bg-primary-orange px-4">
              <div className="flex items-center space-x-2">
                <UtensilsCrossed className="h-8 w-8 text-white" />
                <h1 className="text-xl font-bold text-white">Afly OrderMeals</h1>
              </div>
